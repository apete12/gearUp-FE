...
const Preview = () => {
  ...
  return (
    <>
      <h2 className='description-heading preview-heading'>
        Checkout some recent donation requests:
      </h2>
      <div className='preview-container'>
        ...
        <Link className='explore-more-button' to={`/community-board`}>
          Explore more opportunities to support!
        </Link>
      </div>
    </>
  )
